...
\def{Heteroskedasticity}{In statistics, a sequence of random variables is homoscedastic if all its random variables have the same finite variance; this is also known as homogeneity of variance. The complementary notion is called heteroscedasticity, also known as heterogeneity of variance}
...
\begin{itemize}
  ...
  \item The unconditional expectation, $E[\epsilon^2_t] = \frac{\omega}{1 - a_1}$ for \emphARCH(1)}
